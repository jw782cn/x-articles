# [2026-04-07] Project Glasswing

**原文链接**：[Project Glasswing](https://www.anthropic.com/glasswing) by **Anthropic****发布日期**：2026-04-07
...
Anthropic 承诺向 Project Glasswing 及额外参与者提供的 **1 亿美元**模型使用额度将覆盖此研究预览期间的大量使用。之后，Claude Mythos Preview 将以每百万输入/输出 token 25/125 美元的价格提供给参与者（参与者可以通过 Claude API、Amazon Bedrock、Google Cloud Vertex AI 和 Microsoft Foundry 访问该模型）。
